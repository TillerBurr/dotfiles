...
keymap.set("n", "<M-k>", "<C-w>k", { desc = "Move Window Up" })
keymap.set("n", "<M-j>", "<C-w>j", { desc = "Move Window Down" })
keymap.set("n", "<M-l>", "<C-w>l", { desc = "Move Window left" })
keymap.set("n", "<M-h>", "<C-w>h", { desc = "Move Window right" })
