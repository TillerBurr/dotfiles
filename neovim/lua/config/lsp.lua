...
local custom_attach = function(client, bufnr)
  ...
  if client.server_capabilities.documentFormattingProvider then
    ...
    vim.notify("No Formatter!", vim.log.levels.WARN, { title = "Nvim-config" })
  end
...
local virtualenv_path = "/home/tbaur/tools/nvim_python/.venv"
-- if utils.executable("pylsp") then
  ...
  -- /home/tbaur/tools/nvim_python/.venv/bin
